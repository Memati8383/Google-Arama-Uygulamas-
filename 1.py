...
class GoogleAramaUygulamasi(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()

    def initUI(self):
        self.setWindowTitle('Google Arama Uygulaması')
        self.setGeometry(100, 100, 400, 250)
        self.setWindowIcon(QIcon('google_icon.png'))
        ...
        header_label.setText("Google Arama")
        ...
        self.entry.setStyleSheet("padding: 5px; border: 2px solid #4285f4; border-radius: 5px;")
        ...
        self.arama_dugmesi.clicked.connect(self.google_arama_yap)
        self.arama_dugmesi.setStyleSheet("background-color: #4285f4; color: white; border: none; padding: 10px 20px; font-weight: bold;")
    ...
    def kilavuz_goster(self):
        kilavuz_mesaji = (
            ...
            "<strong>Google Arama Uygulaması Kılavuzu</strong><br><br>"
            ...
            "2. '🔍 Ara' düğmesine tıklayın. Bu, tarayıcınızda Google arama sonuçlarını açacaktır.<br><br>"
            "Daha fazla yardım veya geri bildirim için lütfen aşağıdaki websitem ile iletişime geçin:<br>"
            "<a href='http://akdemirferit.rf.gd' style='color: #4285f4; text-decoration: none;'>akdemirferit.rf.gd</a>"
            "</p></body></html>"
        )
...
if __name__ == '__main__':
    ...
    uygulama = GoogleAramaUygulamasi()
    uygulama.show()
    sys.exit(app.exec_())
